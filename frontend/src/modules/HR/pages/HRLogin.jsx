...
export const HRLogin = () => {
  ...
  useEffect(() => {
    document.title = 'HR & Staff Portal Login | School CRM';
  }, []);
    ...
    <div className="dark h-dvh overflow-hidden bg-slate-950 text-slate-100 lg:grid lg:grid-cols-2">
      ...
      <section className="relative hidden h-full items-center justify-center overflow-hidden px-10 lg:flex">
        ...
        <div className="relative z-10 flex w-full max-w-md flex-col items-center text-center">
          ...
          <h1 className="mt-5 text-3xl font-semibold tracking-tight text-white">HR & Staff Ops</h1>
        ...
        <div className="w-full max-w-[420px]">
          <div className="mb-5 flex flex-col items-center text-center">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-white">
              {view === 'login' ? 'HR & Staff Login' : 'Reset HR Password'}
            </h2>
            <p className="mt-1 text-xs text-slate-400">
              {view === 'login' ? 'Sign in with your HR credentials for staff, payroll, and attendance' : 'Reset your HR account password'}
            </p>
          </div>
            ...
            {view === 'login' && (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  <label className="block text-sm font-medium text-slate-300">HR Email</label>
