        ...
        <div className="w-full max-w-[420px]">
          <div className="mb-5 flex flex-col items-center text-center">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-white">
              {view === 'login' ? 'Accountant Login' : 'Reset Password'}
            </h2>
            <p className="mt-1 text-xs text-slate-400">
              {view === 'login' ? 'Sign in to access fee collections, billing ledgers, and accounts' : 'Reset your accountant credentials'}
            </p>
          </div>
            ...
            {view === 'login' && (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  <label className="block text-sm font-medium text-slate-300">Email / Username</label>
